...
const initSettings = () => {
  ...
  document.getElementById('G1Color').value = `#${settingsSet[7][0]
    .toString(16)
    .padStart(2, '0')}00${settingsSet[7][1].toString(16).padStart(2, '0')}`
  cpG1.value = document.getElementById('G1Color').value
  document.getElementById('G2Color').value = `#${settingsSet[7][2]
    .toString(16)
    .padStart(2, '0')}00${settingsSet[7][3].toString(16).padStart(2, '0')}`
...
const initSettingsFunction = () => {
  ...
  keyInfoArr.forEach((e, indexBak) => {
    const index = [0, 1, 4, 2, 3][indexBak]
