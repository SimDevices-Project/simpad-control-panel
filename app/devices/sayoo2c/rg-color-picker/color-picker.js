;(function() {
  ...
  const heightToRgb = heightPercent => {
    // For RG
    heightPercent = heightPercent / 3
    // if (heightPercent > 0.333333) {
    //   heightPercent = 0
    // }
  ...
  class ColorPicker {
    constructor({ dom = cE('div'), input, value = 'FFF' } = {}) {
      ...
      gradientColor.style.background =
        'linear-gradient(to right,rgba(255,0,0,0),#FF0000)'
    ...
    updatePicker() {
      ...
      this._gradientColor.style.background = `linear-gradient(to right,#ff00ff,#${rgbToHex(
