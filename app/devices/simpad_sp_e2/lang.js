module.exports = {
  'en-US': {
    ...
    changeKeyMode: 'Edit Key Modes',
    changeKeyModeInfo:
      'Key modes can be set separatly, supports auto click and you could edit click delay',
    autoClickDelay: "Auto click dalay",
    autoClickDelayInfo: "Config auto click delay value ( in millisecond )",
    autoClickEnable:"Auto click enable",
    autoClickEnableInfo:"Config auto click enable in each one key on the keypad",
  ...
  'ja-JP': {
    title: 'SimPadコントロールパネル',
    selectDevice: '設備を選定する',
    ...
    otherSettingsBT: '他の選択',
    pleaseWait: '応用中、少々お待ちください',
    successToApply: '応用に成功する',
    exitProgram: '終了',

    edit: '変更',

    changeKeyCode: 'キーワードの設定',
    changeKeyCodeInfo:
      'ここで、各キーのキーワードを設置して、基本の組み合わせキーの機能を支持する',
    viewKeyMap: '設備のキーの定義を調べる',

    changeLights: 'ライトのモデルと色',
    changeLightsInfo:
      'ここでライトのモデルを調整し、又は各組のライトの色を設置する',
    viewLightsMap: '設備のライトの配置を調べる',
    lightsMode: 'モデル',
    easeOut: '押すとつき、次に消える',
    easeIn: '押すと消し、次についている',
    keepOn: '常に明るい',
    keepOff: 'オフ',
    keyPress: '押すとつき',
    ...
    advancedOptions: '高級',
    advancedOptionsInfo: `高級なオプションは一部の高級な操作を提供する。ユーザーがこれらの操作を使うと進めない。高級なオプションにあるすべての操作は確認を無視して直接に応用される。`,
    sendDataPack: 'データパックを送信する',
    sendDataPackInfo: `SimPadのデータパックのフォーマットになれると、直接に設備にデータパックを送信してもいい。ご入力したテキストはスペースに応じて16進数のデータに解析される`,
    sendDataPackBtn: '送信',
    superSpeedMode: 'スーパースピードモード',
    superSpeedModeInfo:
      'スーパースピードモードを使用することで、徹底的にすべてのライト効果をなくすことになります。よって最速の体験を得ることができます。設備を再起動して効果を発揮します。',
    superSpeedModeeBtnOn: 'オン',
    superSpeedModeeBtnOff: 'オフ',

    resetDevice: '設備をリセットする',
    resetDeviceInfo: 'ご設備をリセットして、全ての設置をデフォルトに回復する',
    resetDeviceBtn: 'リセット',
    ...
    <a href="https://www.bysb.net">
      <p class="canBeSeleted">「手柄君様の小閣」のブログに訪問する</p>
    </a>
    <p></p>
    <p>By Handle</p>
    <p>2018.7.4</p>`,
  ...
  'zh-CN': {
    ...
    changeKeyMode: '按键功能',
    changeKeyModeInfo:
      '您可以配置每个按键的特殊功能，例如启用自动连击等特性',
    autoClickDelay: "自动连击延迟",
    autoClickDelayInfo: "配置自动连击的每个动作延迟，单位毫秒",
    autoClickEnable:"启用自动连击功能",
    autoClickEnableInfo:"对于键盘上的每个单独按键，您可以分别启用或禁用自动连击功能",
  ...
  'zh-SG': {
    ...
    changeKeyCode: '按键值设定',
    changeKeyCodeInfo: '您可以在这里分别设置每个键的按键值，支持基本组合键功能',
    viewKeyMap: '查看设备按键配置',
